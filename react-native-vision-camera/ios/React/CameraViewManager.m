...
RCT_EXTERN_METHOD(getAvailableAudioInputs : (RCTPromiseResolveBlock)resolve reject : (RCTPromiseRejectBlock)reject);
RCT_EXTERN_METHOD(getCurrentAudioInput : (RCTPromiseResolveBlock)resolve reject : (RCTPromiseRejectBlock)reject);
RCT_EXTERN_METHOD(setAudioInput : (NSString*)deviceId resolve : (RCTPromiseResolveBlock)resolve reject : (RCTPromiseRejectBlock)reject);
...
RCT_EXPORT_VIEW_PROPERTY(audioInputId, NSString);
