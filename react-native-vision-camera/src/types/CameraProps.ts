...
export interface CameraProps extends ViewProps {
  ...
  audio?: boolean;
  /**
   * Specifies the audio input device to use for recording.
   *
   * If not specified, the default audio input (usually built-in microphone) will be used.
   * Use `getAvailableAudioInputs()` to get a list of available audio input devices.
   *
   * @platform iOS
   */
  audioInputId?: string;
